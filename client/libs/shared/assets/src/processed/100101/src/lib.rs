...
#[receive(contract = "mint_wizard_100101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_100101", name = "serializationHelper", parameter = "PermitMessage")]
