...
#[receive(contract = "mint_wizard_101011", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_101011", name = "serializationHelper", parameter = "PermitMessage")]
