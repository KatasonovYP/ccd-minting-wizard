...
#[init(
    contract = "mint_wizard_111101_V3",
...
#[receive(contract = "mint_wizard_111101_V3", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_111101_V3", name = "serializationHelper", parameter = "PermitMessage")]
