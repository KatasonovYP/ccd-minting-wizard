...
#[receive(contract = "mint_wizard_011111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_011111", name = "serializationHelper", parameter = "PermitMessage")]
