...
#[receive(contract = "mint_wizard_000001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_000001", name = "serializationHelper", parameter = "PermitMessage")]
