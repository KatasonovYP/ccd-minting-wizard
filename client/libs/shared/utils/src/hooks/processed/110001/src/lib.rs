...
#[receive(contract = "mint_wizard_110001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_110001", name = "serializationHelper", parameter = "PermitMessage")]
