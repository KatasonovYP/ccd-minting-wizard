...
#[receive(contract = "mint_wizard", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard", name = "serializationHelper", parameter = "PermitMessage")]
