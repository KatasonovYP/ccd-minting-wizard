...
#[receive(contract = "mint_wizard_001011", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_001011", name = "serializationHelper", parameter = "PermitMessage")]
