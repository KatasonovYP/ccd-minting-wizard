...
#[receive(contract = "mint_wizard_011101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_011101", name = "serializationHelper", parameter = "PermitMessage")]
