...
#[receive(contract = "mint_wizard_110011", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_110011", name = "serializationHelper", parameter = "PermitMessage")]
