...
#[init(
    contract = "mint_wizard_110111_v1",
...
#[receive(contract = "mint_wizard_110111_v1", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_110111_v1", name = "serializationHelper", parameter = "PermitMessage")]
