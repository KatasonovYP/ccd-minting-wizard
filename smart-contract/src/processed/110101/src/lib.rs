...
#[receive(contract = "mint_wizard_110101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_110101", name = "serializationHelper", parameter = "PermitMessage")]
