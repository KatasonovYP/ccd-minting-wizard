...
#[receive(contract = "mint_wizard_101001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_101001", name = "serializationHelper", parameter = "PermitMessage")]
