...
#[receive(contract = "mint_wizard_101101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_101101", name = "serializationHelper", parameter = "PermitMessage")]
