...
#[receive(contract = "mint_wizard_100011", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_100011", name = "serializationHelper", parameter = "PermitMessage")]
