...
#[receive(contract = "mint_wizard_000101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_000101", name = "serializationHelper", parameter = "PermitMessage")]
