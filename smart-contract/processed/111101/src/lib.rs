...
#[receive(contract = "mint_wizard_111101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_111101", name = "serializationHelper", parameter = "PermitMessage")]
