...
#[receive(contract = "mint_wizard_001111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_001111", name = "serializationHelper", parameter = "PermitMessage")]
