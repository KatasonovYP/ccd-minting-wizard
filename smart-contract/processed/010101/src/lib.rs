...
#[receive(contract = "mint_wizard_010101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_010101", name = "serializationHelper", parameter = "PermitMessage")]
