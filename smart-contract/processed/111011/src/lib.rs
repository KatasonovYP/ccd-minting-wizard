...
#[receive(contract = "mint_wizard_111011", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_111011", name = "serializationHelper", parameter = "PermitMessage")]
