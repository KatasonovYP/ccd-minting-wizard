...
#[receive(contract = "mint_wizard_001001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_001001", name = "serializationHelper", parameter = "PermitMessage")]
