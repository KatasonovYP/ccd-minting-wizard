...
#[receive(contract = "mint_wizard_111001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_111001", name = "serializationHelper", parameter = "PermitMessage")]
