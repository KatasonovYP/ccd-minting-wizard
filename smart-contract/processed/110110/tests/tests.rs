...
fn test_preminting() {
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.view".to_string()),
...
fn test_account_transfer() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.transfer".to_string()),
            address:      contract_address,
...
fn test_add_operator() {
    ...
    let update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.updateOperator".to_string()),
            address:      contract_address,
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.operatorOf".to_string()),
            address:      contract_address,
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount:       Amount::zero(),
                address:      contract_address,
                receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.burn".to_string()),
...
fn test_upgrade_without_migration_function() {
    ...
    let update = chain.contract_update(
        ...
        UpdateContractPayload {
            address:      contract_address,
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.upgrade".into()),
...
fn test_pause_functionality() {
    ...
    chain
        .contract_update(SIGNER, PAUSER, PAUSER_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.setPaused".to_string()),
            address:      contract_address,
...
fn test_no_execution_of_state_mutative_functions_when_paused() {
    ...
    let update_operator = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.mint".to_string()),
            address:      contract_address,
...
fn permit(
    ...
    let invoke = chain
        .contract_invoke(BOB, BOB_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            address:      contract_address,
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.viewMessageHash".to_string()),
    ...
    chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount:       Amount::zero(),
                address:      contract_address,
                receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.permit".to_string()),
                message:      OwnedParameter::from_serial(&param)
                    .expect("Should be a valid inut parameter"),
            },
        )
...
fn get_balances(
    ...
    let invoke = chain
        .contract_invoke(ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.balanceOf".to_string()),
            address:      contract_address,
...
fn initialize_chain_and_contract() -> (Chain, AccountKeys, ContractAddress, ModuleReference) {
    ...
    let init = chain
        .contract_init(SIGNER, ALICE, Energy::from(10000), InitContractPayload {
            ...
            init_name: OwnedContractName::new_unchecked("init_mint_wizard_110110".to_string()),
    ...
    let _update = chain
        .contract_update(SIGNER, ALICE, ALICE_ADDR, Energy::from(10000), UpdateContractPayload {
            amount:       Amount::zero(),
            receive_name: OwnedReceiveName::new_unchecked("mint_wizard_110110.grantRole".to_string()),
