...
#[receive(contract = "mint_wizard_100001", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_100001", name = "serializationHelper", parameter = "PermitMessage")]
