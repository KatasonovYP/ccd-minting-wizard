...
#[receive(contract = "mint_wizard_001101", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_001101", name = "serializationHelper", parameter = "PermitMessage")]
