...
#[receive(contract = "mint_wizard_111111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_111111", name = "serializationHelper", parameter = "PermitMessage")]
