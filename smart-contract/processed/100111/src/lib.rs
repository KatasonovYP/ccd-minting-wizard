...
#[receive(contract = "mint_wizard_100111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_100111", name = "serializationHelper", parameter = "PermitMessage")]
