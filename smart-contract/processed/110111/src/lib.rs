...
#[receive(contract = "mint_wizard_110111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_110111", name = "serializationHelper", parameter = "PermitMessage")]
