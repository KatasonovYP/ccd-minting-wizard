...
#[receive(contract = "mint_wizard_101111", name = "view", return_value = "ViewState")]
...
#[receive(contract = "mint_wizard_101111", name = "serializationHelper", parameter = "PermitMessage")]
